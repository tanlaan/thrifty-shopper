...
class PricesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create price" do
    assert_difference('Price.count') do
      post prices_url, params: { price: { price: @price.price, product_id: @price.product_id, store_id: @price.store_id } }
    end
  ...
  test "should update price" do
    patch price_url(@price), params: { price: { price: @price.price, product_id: @price.product_id, store_id: @price.store_id } }
